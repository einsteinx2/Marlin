...
// NOTE: Lowered BANG_MAX to 127 (50%) to prevent initial overshoot. See extensive notes in FlsunQ5 branch...
#define PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Sidewinder X1
  #define DEFAULT_bedKp 45.73
  #define DEFAULT_bedKi 8.09
  #define DEFAULT_bedKd 172.34
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.121, 80.121, 399.778, 464.86 }
